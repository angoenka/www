...
abstract class BaseLogdbPeer {
  ...
  static public function getUniqueColumnNames()
  {
	...
	public static function doValidate(Logdb $obj, $cols = null)
	{
		...
		$res =  BasePeer::doValidate(LogdbPeer::DATABASE_NAME, LogdbPeer::TABLE_NAME, $columns);
    if ($res !== true) {
        $request = sfContext::getInstance()->getRequest();
        foreach ($res as $failed) {
            $col = LogdbPeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
        }
    }
